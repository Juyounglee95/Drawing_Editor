...
public abstract class EditorShape  implements  Serializable{
	...
	public EditorShape(String sid, int x, int y, int w, int h, Color color) {
		this.sid=sid;
		this.x = x;
		this.y = y;
		this.width = w;
	...
	public EditorShape() {
		this("default"+cnt,25,25,25,15, Color.black);
	}
